...
{
    public partial class CreateGroupDMSelectedUserView : UserControl
    {
        ...
        public CreateGroupDMSelectedUserView()
        {
            InitializeComponent();
        }
        ...
        {
            if (_hovered && DataContext is CreateGroupDMSelectedUserViewModel viewModel)
            {
